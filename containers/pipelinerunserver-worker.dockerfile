...
ADD sources/operators/pipelinerunserver/apps/worker/src /workspace/src

# Unit tests
FROM scratch AS tests

ADD tests/operators/pipelinerunserver/apps/worker/ /workspace/tests
...
ENV RABBITMQ_WORKER_QUEUE "worker"
